...
<div class="container-fluid">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('edit-product',$item->id) }}" class="btn btn-blue rounded-pill waves-effect waves-light" title="Edit">
                    <i class="fa fa-pencil" aria-hidden="true"></i></a>
                <a href="{{ route('barcode-product',$item->id) }}" class="btn btn-info rounded-pill waves-effect waves-light" title="Code">
