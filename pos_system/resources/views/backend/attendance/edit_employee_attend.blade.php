               ...
               <div class="card-body">
                  <form action="{{ route('employee-attendance-store') }}" method="post" id="myForm">
                     ...
                     <div class="form-group col-md-4">
                        ...
                        <input type="date" name="date" value="{{ $editdata['0']['date'] }}" id="date" class="checkdate form-control form-control-sm singledatepicker" placeholder="Attendance Date" autocomplete="off">
                     </div>
