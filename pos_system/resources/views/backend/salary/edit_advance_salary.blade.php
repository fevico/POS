...
<div class="container-fluid">
    ...
    <option value="Feburary" {{ $salary->month == 'Feburary' ? "selected" : ''}}>Feburary</option>
...
<div class="col-md-6">
    <div class="mb-3">
        <label for="firstname" class="form-label">Asvance Salary</label>
        <input type="text" name="advance_salary" value="{{ $salary->advance_salary}}" class="form-control @error('advance_salary') is-invalid @enderror" >
