...
<div class="container-fluid">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('order-status-update') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Order Datails </h5>
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
        ...
        <div class="col-md-6">
            <div class="mb-3">
            <label for="firstname" class="form-label"> Paid Ammount</label>
        ...
        <div class="col-md-6">
            <div class="mb-3">
            <label for="firstname" class="form-label"> Due Ammount</label>
    ...
    <tbody>
        ...
        <tr>
            <td><img src="{{ asset($item->product->product_image) }}" alt="" style="width:50px; height:40px;"></td>
