            ...
            <div class="row mt-3">
                <div class="col-sm-6">
                    ...
                    <address>
                        ...
                        <br>
                        <abbr title="Phone">ShopName:</abbr> {{ $customer->shopname}}<br>
            ...
            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                    <div class="auth-logo">
                        ...
                        <h3>Total Ammount ${{ Cart::total(); }}</h3>
                    </div>
                </div>
                ...
                <option value="Due">Due</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="due" placeholder="Due Ammount">
                    </div>
                    ...
                    <input type="hidden" name="invoice_no" value="{{ $customer->id }}">
